...
{
    public partial class ADMN1020Form : Form
    {
        ...
        public ADMN1020Form(BaseForm baseForm, string mode, string sp_code, PrivilegeEntity privileges) //(BaseForm baseForm, string mode, string hierarchy, string year, string sp_code, PrivilegeEntity privileges)
        {
            InitializeComponent();
            BaseForm = baseForm;
            ...
            //if (ShortName == "STDC" || ShortName == "PCS" || ShortName == "NCCAA" || ShortName == "FTW" || ShortName == "BVCOG" || ShortName == "CSNT"
            //    || ShortName == "HCCAA" || ShortName == "RMPC" || ShortName == "CVCAA")
            if(BaseForm.BaseAgencyControlDetails.State=="TX")
            {
                Cb_Allow_Add_Branch.Visible = false; cbNoSPM.Visible = true;
                //cbNoSPM.Location = new System.Drawing.Point(167, 3); 
            }
            else { cbNoSPM.Visible = false; Cb_Allow_Add_Branch.Visible = true; }

            PAYMENTService = _model.SPAdminData.Get_AgyRecs_With_Ext("00201", "6", "2", null, null);
            //CommonFunctions.AgyTabsFilterCode(BaseForm.BaseAgyTabsEntity, "00201", BaseForm.BaseAgency, BaseForm.BaseDept, BaseForm.BaseProg, string.Empty);
            ...
            switch (Mode)
            {
                case "Edit":
                    ...
                    /* kranthi commented 
                        this.panel1.Size = new System.Drawing.Size(666, 68);
                        ...
                        this.panel4.Location = new System.Drawing.Point(1, 463);//1,280
                        this.Size = new System.Drawing.Size(670, 497);
                    */
                ...
                case "Add":
                    ...
                    this.Size = new System.Drawing.Size(this.Width - 50, this.Height - (SpDetailsPanel.Height));

                    //if (Member_Activity == "N")
                    //{
                    //    this.panel1.Size = new System.Drawing.Size(666, 68);//666, 64
                    //    this.BranchPanel.Location = new System.Drawing.Point(1, 124);//1, 119
                    ...
                    //    this.Size = new System.Drawing.Size(670, 320);//(670, 315)
                    //}
                    ...
                    /* kranthi commented 
                    this.panel1.Size = new System.Drawing.Size(666, 68);
                    this.BranchPanel.Size = new System.Drawing.Size(666, 160); //606
                    this.BranchGrid.Size = new System.Drawing.Size(336, 154);
                    this.HierarchyGrid.Size = new System.Drawing.Size(222, 154);
                    ...
                    */
                    ...
                    //lblCategory.Visible = true;cmbCategory.Visible = true; label2.Visible = true;
                    //this.panel1.Size = new System.Drawing.Size(666, 95);
                    //this.BranchPanel.Size = new System.Drawing.Size(606, 160);
                    //this.BranchGrid.Size = new System.Drawing.Size(336, 154);
                    //this.HierarchyGrid.Size = new System.Drawing.Size(222, 154);
                    //this.panel4.Location = new System.Drawing.Point(1, 311);
            ...
            // tooltip.SetToolTip(Hepl_Click, "Screen Help");
        }
        ...
        public List<Agy_Ext_Entity> PAYMENTService { get; set; }
            ...
            if (form.DialogResult == DialogResult.OK)
            {
                ...
                if (selectedHierarchies.Count > 0)
                {
                    ...
                    foreach (HierarchyEntity row in selectedHierarchies)
                    {
                        ...
                        {
                            ProgramDefinitionEntity DefEntity = CASEDEP_List.Find(u => u.Agency == row.Agency && u.Dept == row.Dept && u.Prog == row.Prog);
                            if (DefEntity != null)
                            {
                                if (!string.IsNullOrEmpty(DefEntity.DepSerpostPAYCAT.Trim()))
                                {
                                    ...
                                    if (AgyEnt != null)
                                    { lblCatg.Visible = true; lblCatg.Text = "Category : " + AgyEnt.Desc.Trim(); lblPayCat.Text = DefEntity.DepSerpostPAYCAT; PayCatg = DefEntity.DepSerpostPAYCAT; }
                            ...
                            if (PPC_List.Count > 0)
                            {
                                ...
                                if (PPC_List.Count > 0)
                                {
                                    foreach (Agy_Ext_Entity Entity in PPC_List)
                                    {
                                        ...
                                        {
                                            if (row.Code.Substring(0, 2) == Entity.Ext_1.Substring(0, 2))
                                            {
                                                if (Rows_Cnt == 0)
                                                { PayCatg = Entity.Ext_2.Trim(); lblPayCat.Text = PayCatg; lblCatg.Visible = true; lblCatg.Text = "Category : " + Entity.Desc.Trim(); break; }
                                            }
                                        }
                                    }
                                }
                        ...
                        {
                            CntlCAEntity = _model.FieldControls.GetFLDCNTLHIE("CASE0063", Agy + Dept + Prog, "FLDCNTL");
                        }
                        IsHouseholdButton(PayCatg);
        ...
        private void BtnAddDetails_Click(object sender, EventArgs e)
        {
            ...
            if (BranchGrid.SelectedRows[0].Cells["Dup_Def"].EditedFormattedValue.ToString() != " ")
                Branch_Code = BranchGrid.SelectedRows[0].Cells["Branch_Code"].EditedFormattedValue.ToString();
        ...
        private void Fill_SP_Branch_Hier()
        {
            ...
            //{
            //    List<CASESP2Entity> MSDetails = new List<CASESP2Entity>();
            //    MSDetails = CAMA_Details.FindAll(u => u.Type1.Equals("MS"));

            //    if(MSDetails.Count>0 && SP_Header_Rec.Validate == "N")
            //        BtnValidate.Visible = true;
            //    else if (MSDetails.Count == 0 && SP_Header_Rec.Validate == "N" )
            //    {
            ...
            //    }
            //}
            //else if (SP_Header_Rec.Validate == "N")
            //    BtnValidate.Visible = true;
        ...
        private void Fill_SP_Hierarchies_Grid()
        {
            ...
            if (SP_Hierarchies.Count > 0)
            {
                ...
                foreach (CASESP1Entity Entity in SP_Hierarchies)
                {
                    ...
                    if (CASEDEP_List.Count > 0)
                    {
                        ProgramDefinitionEntity DefEntity = CASEDEP_List.Find(u => u.Agency == Entity.Agency && u.Dept == Entity.Dept && u.Prog == Entity.Prog);
                        if (DefEntity != null)
                        {
                            if (!string.IsNullOrEmpty(DefEntity.DepSerpostPAYCAT.Trim()))
                            {
                                ...
                                if (AgyEnt != null)
                                { lblCatg.Visible = true; lblCatg.Text = "Category : " + AgyEnt.Desc.Trim(); lblPayCat.Text = DefEntity.DepSerpostPAYCAT; }

                                if (!string.IsNullOrEmpty(lblPayCat.Text.Trim()))
                                {
                                    CntlCAEntity = _model.FieldControls.GetFLDCNTLHIE("CASE0063", Entity.Agency + Entity.Dept + Entity.Prog, "FLDCNTL");
                                }
        ...
        private void Fill_Branch_CAMS_Details_Grid()
        {
            ...
            if (CAMA_Details.Count > 0)
            {
                ...
                foreach (CASESP2Entity Entity in CAMA_Details)
                {
                    ...
                    if (Entity.Branch == BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString())
                    {
                        ...
                        Tmp_Entity.SP2_Spl_Ins = Entity.SP2_Spl_Ins;
                ...
                {
                    this.SpDesc.HeaderText = BranchGrid.SelectedRows[0].Cells["BranchDef"].Value.ToString().Trim();
        ...
        private void SPDetailsGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (SPDetailsGrid.Rows.Count > 0)// && !Btn_Validate_Branch.Visible)
            {
                ...
                if (e.ColumnIndex == 0 && e.RowIndex != -1)
                {
                    ...
                    //{
                    if (int.Parse(SPDetailsGrid.SelectedRows[0].Cells["CA_Post_Count"].Value.ToString()) > 0)
                        Can_Delete = false;
                    //}
                    //else
                    //{
                    ...
                    if (Can_Delete)
                    {
                        ...
                        {
                            case 0:
                                Tmp = SPDetailsGrid.SelectedRows[0].Cells["Del"].Value.ToString();
                                if (Tmp == "True")
                                {
                                    SPDetailsGrid.SelectedRows[0].Cells["Del"].Value = true;
                                    Sel_Del_Count++;
                                }
                                else
                                {
                                    SPDetailsGrid.SelectedRows[0].Cells["Del"].Value = false;
                                    if (Sel_Del_Count > 0)
                                        Sel_Del_Count--;
                                }
                                break;
                    ...
                    else
                    {
                        ...
                        if (SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString() == "CA")
        ...
        private void Delete_Selected_CAMS(DialogResult dialogresult)
        {
            ...
            if (dialogresult == DialogResult.Yes)
            {
                ...
                string Branch_Code = BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString(), CAMS_Type = null, CAMS_Code = null;
                int Row_Seq = 0, Org_Group = 0;

                List<DataGridViewRow> lstSelRows = SPDetailsGrid.Rows.Where(x => x.Cells["Del"].Value.ToString() == true.ToString() && x.Cells["Existing_CA_MS_SW"].Value.ToString() == "Y").ToList();

                foreach (DataGridViewRow dr in lstSelRows) // SPDetailsGrid.Rows
                {
                   // if (dr.Cells["Del"].Value.ToString() == true.ToString() && dr.Cells["Existing_CA_MS_SW"].Value.ToString() == "Y")
                    //{
                        ...
                        else
                        {
                            ...
                            pmtflddata.PMFLDH_SCR_HIE = HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString();
                            pmtflddata.PMFLDH_SP = int.Parse(SP_Code).ToString();
                            pmtflddata.PMFLDH_BRANCH = Branch_Code;
                            pmtflddata.PMFLDH_CURR_GRP = Org_Group.ToString();
                            pmtflddata.PMFLDH_CA_CODE = CAMS_Code;
                            pmtflddata.PMFLDH_CATG = lblPayCat.Text.Trim();
        ...
        private void Prepare_Menu_items()
        {
            ...
            if (CAMA_Details.Count > 0)
            {
                foreach (CASESP2Entity Entity in CAMA_Details)
                {
                    if (BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString() == Entity.Branch)
                    {
        ...
        List<PopUp_Menu_L1_Entity> listItem_L4_Menu = new List<PopUp_Menu_L1_Entity>();
        ...
        private void contextMenu1_Popup(object sender, EventArgs e)
        {
            ...
            if (lblPayCat.Text == "04")
            {
                bool Can_paste_CAMS = true;
                listItem_L1_Menu.Clear();
                listItem_L4_Menu.Clear();

                if (SPDetailsGrid.Rows.Count > 0)
                {
                    if (!Move_Copy_Rec_Sel)
                    {
                        string Default_Status = SPDetailsGrid.SelectedRows[0].Cells["SP_SplIns"].Value.ToString();
                        if (Default_Status != "N")
                        {
                            if (Default_Status == "D")
                                listItem_L4_Menu.Add(new PopUp_Menu_L1_Entity("", "Remove Default CEAP Post"));
                            else if (Default_Status == "S")
                                listItem_L4_Menu.Add(new PopUp_Menu_L1_Entity("", "Remove Post with SPM"));
                            else
                            {
                                if (BaseForm.BaseAgencyControlDetails.State == "TX")
                                    listItem_L4_Menu.Add(new PopUp_Menu_L1_Entity("D", "Default CEAP Post"));
                                listItem_L4_Menu.Add(new PopUp_Menu_L1_Entity("P", "Post with SPM"));
                            }
                        }
                        ...
                        foreach (PopUp_Menu_L1_Entity Ent_1 in listItem_L4_Menu)
                        {
                            MenuItem Menu_L1 = new MenuItem();
                            Menu_L1.Text = Ent_1.Cat_Desc;
                            Menu_L1.Tag = Ent_1.Cat_Code;
                    ...
                    {
                        if (Sel_Move_Copy_Rec_Details[0] == SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString().Trim() &&
                                 Sel_Move_Copy_Rec_Details[1] == SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString().Trim() &&
                                 Sel_Move_Copy_Rec_Details[4] == SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString() &&
                                 Sel_Move_Copy_Rec_Details[2] == SPDetailsGrid.SelectedRows[0].Cells["CAMA_Org_Grp"].Value.ToString().Trim() &&
                                 Sel_Move_Copy_Rec_Details[3] == SPDetailsGrid.SelectedRows[0].Cells["Sequence"].Value.ToString().Trim())
                        {
                        ...
                        else
                        {
                            if (Can_paste_CAMS)
                            {
                                listItem_L1_Menu.Add(new PopUp_Menu_L1_Entity("S", "Paste ABOVE"));
                                listItem_L1_Menu.Add(new PopUp_Menu_L1_Entity("B", "paste BELOW"));
                            }
                        }
                    }
                    string Active_Status = SPDetailsGrid.SelectedRows[0].Cells["Active_Stat"].Value.ToString();
                    if (Active_Status != "N")
                    {
                        if (Active_Status == "A")
                    ...
                    if (SP_Header_Rec.Auto_Post_SP == "Y")
                    {
                        string Autopost = SPDetailsGrid.SelectedRows[0].Cells["Auto_Post"].Value.ToString();
                        if (Autopost == "Y")
            ...
            foreach (PopUp_Menu_L2_Entity Ent_2 in listItem_L2_Menu)
            {
                foreach (PopUp_Menu_L3_Entity Ent_3 in listItem_L3_Menu)
                {
                    if (Ent_2.Cat_Code == "C" && Ent_2.Cat_Code == Ent_3.Cat_Code && Ent_2.Grp_Code == Ent_3.Curr_Grp &&
                        Ent_2.Grp_Code.ToString() != SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString().Trim())
                    {
                        MenuItem Menu_Move_L2 = new MenuItem();
                        Menu_Move_L2.Text = Ent_2.Grp_Desc;
                ...
                if (SPDetailsGrid.CurrentRow.Cells["Group"].Value.ToString() != Grp_Code.ToString())
                {
                    foreach (CASESP2Entity Entity in Branch_CAMS_Details) // CAMA_Details) //////Branch_CAMS_Details) 
                    {
                        ...
                        if (Grp_Code == Entity.Curr_Grp &&
                            Entity.CamCd.Trim() == SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString().Trim() &&
                            Entity.Type1 == SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString().Trim())// &&
                        {
                            Can_Add = false; break;
                        }
                    }
        ...
        private void SPDetailsGrid_SelectionChanged(object sender, EventArgs e)
        {
            ...
            Curr_Group = int.Parse(SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString());

            ////if (Priv_Group != Curr_Group)
            contextMenu1_Popup(contextMenu1, EventArgs.Empty);

            ////Priv_Group = Curr_Group;
            lblFldcntl.Visible = false;
            if (!string.IsNullOrEmpty(lblPayCat.Text.Trim()))
                FieldCntlOverRide();
        ...
        {
            //pictureBox2.Visible = false;
            ////this.SpDetailsPanel.Location = new System.Drawing.Point(1, 107); // 146
            //this.SpDetailsPanel.Location = new System.Drawing.Point(1, 119); // 146

            ////this.SpDetailsPanel.Size = new System.Drawing.Size(606, 315);    // 277
            ////this.SpDetailsPanel.Size = new System.Drawing.Size(606, 320);    // 277
            ////this.SpDetailsPanel.Size = new System.Drawing.Size(606, 317);    // 277
            //this.SpDetailsPanel.Size = new System.Drawing.Size(666, 317);
            ////this.SPDetailsGrid.Size = new System.Drawing.Size(582, 310);    // 270
            //this.SPDetailsGrid.Size = new System.Drawing.Size(641, 310); //635
            ////this.pictureBox3.Location = new System.Drawing.Point(586, 2); // 146
            ...
            this.SpDetailsPanel.Size = new System.Drawing.Size(666, 317);
            this.SPDetailsGrid.Location = new System.Drawing.Point(3, 25);
        ...
        private void pictureBox3_Click_1(object sender, EventArgs e)
        {
            ...
            ////this.SpDetailsPanel.Location = new System.Drawing.Point(1, 223); // 146
            //this.SpDetailsPanel.Location = new System.Drawing.Point(1, 233); // 146
            ////this.SpDetailsPanel.Size = new System.Drawing.Size(606, 200);    // 277
            //this.SpDetailsPanel.Size = new System.Drawing.Size(666, 201);
            ////this.SPDetailsGrid.Size = new System.Drawing.Size(582, 194);    // 270
            //this.SPDetailsGrid.Size = new System.Drawing.Size(641, 194); //635
            //if (SPDetailsGrid.Rows.Count >= 9)
            //    pictureBox2.Visible = true;
            ////this.Size = new System.Drawing.Size(610, 472);
            ...
            //{
            this.SpDetailsPanel.Location = new System.Drawing.Point(1, 237);
            this.SpDetailsPanel.Size = new System.Drawing.Size(666, 224);
            this.SPDetailsGrid.Location = new System.Drawing.Point(3, 25);
        ...
        private void SPDetailsGrid_MenuClick(object objSource, MenuItemEventArgs objArgs)
        {
            ...
            if (objArgs.MenuItem.Tag is string)
            {
                ...
                if ((CAMS_Move_Copy_Details[0] == "M" || CAMS_Move_Copy_Details[0] == "C") && !Move_Copy_Rec_Sel)
                {
                    ...
                    Sel_Move_Copy_Rec_Details[0] = SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString().Trim();
                    Sel_Move_Copy_Rec_Details[1] = SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString().Trim();
                    Sel_Move_Copy_Rec_Details[2] = SPDetailsGrid.SelectedRows[0].Cells["CAMA_Org_Grp"].Value.ToString().Trim();
                    Sel_Move_Copy_Rec_Details[3] = SPDetailsGrid.SelectedRows[0].Cells["Sequence"].Value.ToString();
                    Sel_Move_Copy_Rec_Details[4] = SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString();
                ...
                if (CAMS_Move_Copy_Details[0] != "A" && CAMS_Move_Copy_Details[0] != "I" && CAMS_Move_Copy_Details[0] != "D" && CAMS_Move_Copy_Details[0] != "P" && CAMS_Move_Copy_Details[0] != "")//&& lblPayCat.Text!="04")   // To Allow only Move Or Copy Operations
                {
                    Split_Array = null;
                    Split_Array = Regex.Split(objArgs.MenuItem.Tag.ToString(), " ");
                    ...
                    CAMS_Move_Copy_Details[0] = SPDetailsGrid.SelectedRows[0].Cells["Sequence"].Value.ToString();
                    //if (Move_Copy_Above_Below_Flag == "B")
                    //{
                    //    if(int.Parse(CAMS_Move_Copy_Details[0]) < int.Parse(Sel_Move_Copy_Rec_Details[3]))
                    //    CAMS_Move_Copy_Details[0] = (int.Parse(CAMS_Move_Copy_Details[0]) + 1).ToString();
                    //}
                    //else
                    //{
                    //    if (int.Parse(CAMS_Move_Copy_Details[0]) > int.Parse(Sel_Move_Copy_Rec_Details[3]))
                    ...
                    //if (CAMS_Move_Copy_Details[0] == Sel_Move_Copy_Rec_Details[3] ||
                    //    int.Parse(CAMS_Move_Copy_Details[0]) == (int.Parse(Sel_Move_Copy_Rec_Details[3]) + 1))  // To bypass if trying to Move/Copy at same sequence
                    //{
                    //    Move_Copy_Rec_Sel = false;
                    //    Sel_Opr_Move_Copy = "";

                    //    if (CAMS_Move_Copy_Details[0] == Sel_Move_Copy_Rec_Details[3])
                    //        SPDetailsGrid.Rows[int.Parse(CAMS_Move_Copy_Details[0]) - 1].DefaultCellStyle.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular);
                    //    else
                    //        SPDetailsGrid.Rows[int.Parse(Sel_Move_Copy_Rec_Details[3]) - 1].DefaultCellStyle.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular);
                    //    return;
                    //}

                    CAMS_Move_Copy_Details[2] = Sel_Opr_Move_Copy;        // Operation to Perform (Move 'M' / Coyp 'C')
                    CAMS_Move_Copy_Details[3] = SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString();        // Current Group of Selected Record
                ...
                else
                {
                    ...
                    {
                        if (Ent.CamCd.Trim() == SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString().Trim() &&
                            Ent.Type1 == SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString().Trim() &&
                            Ent.Orig_Grp.ToString() == SPDetailsGrid.SelectedRows[0].Cells["CAMA_Org_Grp"].Value.ToString().Trim())
                        {
                            if (CAMS_Move_Copy_Details[0] == "A") Ent.SP2_CAMS_Active = CAMS_Move_Copy_Details[0];
                            else if (CAMS_Move_Copy_Details[0] == "I") Ent.SP2_CAMS_Active = CAMS_Move_Copy_Details[0];
                            if (CAMS_Move_Copy_Details[0] == "D") Ent.SP2_Spl_Ins = CAMS_Move_Copy_Details[0]; else if (CAMS_Move_Copy_Details[0] == "P") Ent.SP2_Spl_Ins = CAMS_Move_Copy_Details[0]; else Ent.SP2_Spl_Ins = "";
                            Ent.lstcOperator = BaseForm.UserID;
                            if (_model.SPAdminData.UpdateCASESP2(Ent, string.Empty, out Sql_SP_Result_Message))
                            {
                                SPDetailsGrid.SelectedRows[0].Cells["Active_Stat"].Value = CAMS_Move_Copy_Details[0];
                                SPDetailsGrid.SelectedRows[0].Cells["SP_SplIns"].Value = CAMS_Move_Copy_Details[0];
                                if (CAMS_Move_Copy_Details[0] == "A")
                                    SPDetailsGrid.SelectedRows[0].DefaultCellStyle.ForeColor = Color.Black;
                                else if (CAMS_Move_Copy_Details[0] == "I")
                                    SPDetailsGrid.SelectedRows[0].DefaultCellStyle.ForeColor = Color.Red;
                            }
                        }
                    }
                }
        ...
        private void Set_Reset_Auto_Post_Option(string Set)
        {
            foreach (CASESP2Entity Ent in Branch_CAMS_Details) // rao 06282014
            {
                    ...
                    Ent.Orig_Grp.ToString() == SPDetailsGrid.SelectedRows[0].Cells["CAMA_Org_Grp"].Value.ToString().Trim())
                {
                    ...
                    if (_model.SPAdminData.UpdateCASESP2(Ent, string.Empty, out Sql_SP_Result_Message))
                    {
                        SPDetailsGrid.SelectedRows[0].Cells["Auto_Post"].Value = Set;

                        if (Set == "Y")
                            SPDetailsGrid.SelectedRows[0].Cells["Auto_Post_Disp"].Value = "A";
                        else
                            SPDetailsGrid.SelectedRows[0].Cells["Auto_Post_Disp"].Value = "";
        ...
        private void Move_Copy_SelectedCAMS()
        {
            ...
            if (CAMA_Details.Count > 0)
            {
                Target_Move_Copy_Rec_Details[0] = SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString().Trim();
                Target_Move_Copy_Rec_Details[1] = SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString().Trim();
                Target_Move_Copy_Rec_Details[2] = SPDetailsGrid.SelectedRows[0].Cells["CAMA_Org_Grp"].Value.ToString().Trim();
                Target_Move_Copy_Rec_Details[3] = SPDetailsGrid.SelectedRows[0].Cells["Sequence"].Value.ToString();
                Target_Move_Copy_Rec_Details[4] = SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString();
                ...
                foreach (CASESP2Entity Entity in Branch_CAMS_Details)
                {
                    ...
                    //////////if (!Row_Shifted && (Entity.Row.ToString() == CAMS_Move_Copy_Details[0]) &&   // Adds to entity when moved from Lower Sequence to Heigher Sequence
                    //////////    (int.Parse(SPDetailsGrid.CurrentRow.Cells["Sequence"].Value.ToString()) > int.Parse(CAMS_Move_Copy_Details[0])))

                    //if (!Row_Shifted && (Entity.Row.ToString() == CAMS_Move_Copy_Details[0]) &&   // Adds to entity when moved from Lower Sequence to Heigher Sequence
                    //    (int.Parse(Sel_Move_Copy_Rec_Details[3]) > int.Parse(CAMS_Move_Copy_Details[0])))
                    //{
                    //    New_CAMA_Details.Add(new CASESP2Entity(New_Rec_To_CopyMove)); Row_Shifted = true;
                    //}

                    //////////if (CAMS_Move_Copy_Details[2] == "M" && Entity.Row.ToString() == SPDetailsGrid.CurrentRow.Cells["Sequence"].Value.ToString()) //To Bypass Selected CA/MS in Move

                    //if (CAMS_Move_Copy_Details[2] == "M" && Entity.Row.ToString() == Sel_Move_Copy_Rec_Details[3]) //To Bypass Selected CA/MS in Move
                    //    Can_Add_Rec = false;
                    ...
                    //////////if (!Row_Shifted && (Entity.Row.ToString() == CAMS_Move_Copy_Details[0]) &&   // Adds to entity when moved from Heigher Sequence to Lower Sequence
                    //////////    (int.Parse(SPDetailsGrid.CurrentRow.Cells["Sequence"].Value.ToString()) < int.Parse(CAMS_Move_Copy_Details[0])))
                ...
                if (Branch_CAMS_Details.Count > 0)
                {
                    ...
                    foreach (CASESP2Entity Entity in Branch_CAMS_Details) ////// CAMA_Details) //////Branch_CAMS_Details
                    {
                        ...
                        rowIndex = SPDetailsGrid.Rows.Add(false, Entity.CAMS_Desc, Entity.CamCd, TypeChange, Autopost_Disp, Entity.Curr_Grp, Entity.Row, Entity.Type1, Entity.Curr_Grp, Entity.Orig_Grp, Entity.CAMS_Post_Count, Entity.CAMS_Post_Count, (Entity.CAMS_Active == "False" ? "N" : Entity.SP2_CAMS_Active), Entity.Existing_CAMS, Entity.SP2_Auto_Post, Entity.SP2_Spl_Ins, Entity.SP2_OBF, Entity.SP2_COUNT_TYPE);
        ...
        private void Update_CASESP1_Hierarchies()
        {
            ...
            ////if (Mode.Equals("Edit"))
            ////{
            ////    foreach (CASESP1Entity CompareENT in SP_Hierarchies)
            ////    {
            ...
            ////            if (!_model.SPAdminData.UpdateCASESP1(Entity, out Sql_SP_Result_Message))
            ////                Hierarchy_Saved = false;


            ////            //DataSet ds = new DataSet();
            ////            //ds = _model.SPAdminData.UpdateCASESP1(Entity); // 10292012
            ...
            ////            Entity.Code = SP_Code;
            ////        else
            ////            Entity.Code = New_SP_Code.ToString();
        ...
        private void BranchGrid_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (Mode.Equals("Edit") && BranchGrid.SelectedRows[0].Cells["CAMS_Det_SW"].EditedFormattedValue.ToString() == "Y")
            {
                if (string.IsNullOrEmpty(BranchGrid.SelectedRows[0].Cells["BranchDef"].EditedFormattedValue.ToString().Trim()))
                {
                    BranchGrid.SelectedRows[0].Cells["BranchDef"].Value = BranchGrid.SelectedRows[0].Cells["Dup_Def"].Value.ToString();
                    ...
                    BranchGrid.SelectedRows[0].DefaultCellStyle.ForeColor = Color.Black;
                    Can_Proceed = false;
                }
                else
                    BranchGrid.SelectedRows[0].DefaultCellStyle.ForeColor = Color.Red;
            }
            ...
            if (Can_Proceed)
            {
                if (!string.IsNullOrEmpty(BranchGrid.SelectedRows[0].Cells["BranchDef"].EditedFormattedValue.ToString().Trim()))
                {
                    if (BranchGrid.SelectedRows[0].Cells["BranchDef"].Value.ToString() != BranchGrid.SelectedRows[0].Cells["Dup_Def"].Value.ToString())
                    {
                        if (BranchGrid.SelectedRows[0].Cells["Dup_Def"].Value.ToString() == " ")
                            BranchGrid.SelectedRows[0].Cells["Row_status"].Value = "A";
                        else
                            BranchGrid.SelectedRows[0].Cells["Row_status"].Value = "Y";

                        if (BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString() == "P")
                            _errorProvider.SetError(BranchGrid, null);

                        BranchGrid.SelectedRows[0].DefaultCellStyle.ForeColor = Color.Blue;
                    }
                }
                else
                {
                    if (!string.IsNullOrEmpty(BranchGrid.SelectedRows[0].Cells["Dup_Def"].Value.ToString().Trim()))
                    {
                        BranchGrid.SelectedRows[0].Cells["Row_status"].Value = "D";
                        BranchGrid.SelectedRows[0].DefaultCellStyle.ForeColor = Color.Red;
                    }
                }
            }
        ...
        private void Rerrange_Seq_Groups()
        {
            ...
            if (Branch_CAMS_Details.Count > 0)
            {
                ...
                string Cur_Grp = SPDetailsGrid.SelectedRows[0].Cells["CAMA_Org_Grp"].Value.ToString().Trim();
                string Type = SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString().Trim();
                string Tmp_CAMS_Code = SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString().Trim();

                SPDetailsGrid.Rows.Clear();
                Branch_CAMS_Details.Clear();
                Branch_CAMS_Details = _model.SPAdminData.Browse_CASESP2(SP_Code, BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString(), null, null);
                ...
                if (Branch_CAMS_Details.Count > 0) //CAMA_Details
                {
                    foreach (CASESP2Entity Entity in Branch_CAMS_Details) //CAMA_Details
                    {
                        ...
                        ////DataSet ds = new DataSet();
                        //ds = _model.SPAdminData.UpdateCASESP2(Entity, "RowChange", out Sql_SP_Result_Message); // 10292012
                        //if (ds.Tables[0].Rows.Count > 0)
                        //{
                        //    if (ds.Tables[0].Rows[0]["SP_Result"].ToString() == "false")
                        //    {
        ...
        private void ValiDate_Branch()
        {
            ...
            if (CAMA_Details.Count > 0 || Cb_Allow_Add_Branch.Checked)
            {
                ...
                if (Branch_CAMS_Details.Count > 0)
                {
                    ...
                    //}
                    Total_Branches = 1;
                    Branch_List = BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString().Trim();
        ...
        private void HierarchyGrid_MenuClick(object objSource, MenuItemEventArgs objArgs)
        {
            ...
            if (objArgs.MenuItem.Tag is string)
            {
                ...
                SP_Header_Rec.Default_Prog = HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString();
                SP_Header_Rec.lstcOperator = BaseForm.UserID;
                ...
                if (_model.SPAdminData.UpdateCASESP0(SP_Header_Rec, out New_SP_Code, out Sql_SP_Result_Message))
                {
                    AlertBox.Show("Service Plan Default Hierarchy Updated Successfully");
                    Fill_SP_Hierarchies_Grid();
                }
            }
        }
        ...
        private void SPDetailsGrid_DoubleClick(object sender, EventArgs e)
        {

            if (SPDetailsGrid.CurrentCell.ColumnIndex != 15 && SPDetailsGrid.SelectedRows[0].Cells[0].ColumnIndex != 16)
            {
                if (!string.IsNullOrEmpty(lblPayCat.Text.Trim()) && SPDetailsGrid.SelectedRows[0].Cells["Type"].Value.ToString() == "CA")
                {
                    //if(lblPayCat.Text.Trim()=="02")
                    propPMTFLDCNTLHEntity = _model.FieldControls.GETPMTFLDCNTLHSP("CASE0063", lblPayCat.Text.Trim(), HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString(), txtcode.Text.Trim(), BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString(), SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString(), SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString(), "SP");
                    propPMTFLDCNTLHEntity = propPMTFLDCNTLHEntity.FindAll(u => u.PMFLDH_CATG == lblPayCat.Text.Trim());
                    //else
                    //    propPMTFLDCNTLHEntity = _model.FieldControls.GETPMTFLDCNTLHSP("PAYCAT"+ lblPayCat.Text.Trim(), lblPayCat.Text.Trim(), HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString(), txtcode.Text.Trim(), BranchGrid.CurrentRow.Cells["Branch_Code"].Value.ToString(), SPDetailsGrid.CurrentRow.Cells["Group"].Value.ToString(), SPDetailsGrid.CurrentRow.Cells["CAMS_Code"].Value.ToString(), "SP");

                    if (propPMTFLDCNTLHEntity.Count == 0)
                    {
                        //if (lblPayCat.Text.Trim() == "02")
                        propPMTFLDCNTLHEntity = _model.FieldControls.GETPMTFLDCNTLHSP("CASE0063", lblPayCat.Text.Trim(), HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString(), "0", " ", "0", "          ", "hie");
                        propPMTFLDCNTLHEntity = propPMTFLDCNTLHEntity.FindAll(u => u.PMFLDH_CATG == lblPayCat.Text.Trim());
                        //else
                        //    propPMTFLDCNTLHEntity = _model.FieldControls.GETPMTFLDCNTLHSP("PAYCAT" + lblPayCat.Text.Trim(), lblPayCat.Text.Trim(), HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString(), "0", " ", "0", "          ", "hie");
                    }

                    PaymentFieldControlForm form = new Forms.PaymentFieldControlForm(BaseForm, Mode, lblPayCat.Text.Trim(), HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString(), txtcode.Text.Trim(), BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString(), SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString(), SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString(), SPDetailsGrid.SelectedRows[0].Cells["SpDesc"].Value.ToString(), propPMTFLDCNTLHEntity);
        ...
        {
            PaymentFieldControlForm form = sender as PaymentFieldControlForm;
            if (form.DialogResult == DialogResult.OK)
            {
                FieldCntlOverRide();
        ...
        private void HierarchyGrid_SelectionChanged(object sender, EventArgs e)
        {
            if (HierarchyGrid.Rows.Count > 0)
            {
                string PayCatg = string.Empty;
                if (string.IsNullOrEmpty(lblPayCat.Text.Trim()))
                {
                    ...
                    //            if (!string.IsNullOrEmpty(Entity.Ext_1.Trim()))
                    //            {
                    //                if (HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString().Substring(0, 2) == Entity.Ext_1.Substring(0, 2))
                    //                {
                    //                    PayCatg = Entity.Code.Trim(); lblPayCat.Text = PayCatg; lblCatg.Visible = true; lblCatg.Text = "Category : " + Entity.Desc.Trim(); break;
                    //                }
                    //            }
                    //        }
                    //    }
                    ...
                    lblPayCat.Text = ""; lblCatg.Text = "";
                    if (CASEDEP_List.Count > 0)
                    {
                        ProgramDefinitionEntity DefEntity = CASEDEP_List.Find(u => u.Agency == HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString().Substring(0, 2) 
                        && u.Dept == HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString().Substring(2, 2) && u.Prog == HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString().Substring(4, 2));
                        if (DefEntity != null)
                        {
                            if (!string.IsNullOrEmpty(DefEntity.DepSerpostPAYCAT.Trim()))
                            {
                    ...
                    {
                        CntlCAEntity = _model.FieldControls.GetFLDCNTLHIE("CASE0063", HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString(), "FLDCNTL");
                    }
                    IsHouseholdButton(PayCatg);
                ...
                else
                {
                    ...
                    if (CASEDEP_List.Count > 0)
                    {
                        //ProgramDefinitionEntity DefEntity = CASEDEP_List.Find(u => u.Agency == HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString().Substring(0, 2) && u.Dept == HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString().Substring(2, 2) && u.Prog == HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString().Substring(4, 2));
                        ProgramDefinitionEntity DefEntity = CASEDEP_List.Find(u => u.Agency == HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString().Substring(0, 2) && u.Dept == HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString().Substring(2, 2) && u.Prog == HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString().Substring(4, 2));
                        if (DefEntity != null)
                        {
                            if (!string.IsNullOrEmpty(DefEntity.DepSerpostPAYCAT.Trim()))
                            {
        ...
        {
            //ADMN1020_Household newForm = new ADMN1020_Household(BaseForm, Mode, SP_Code, Privileges);
            //newForm.ShowDialog();
        }
        ...
        private void FieldCntlOverRide()
        {
            propPMTFLDCNTLHEntity = _model.FieldControls.GETPMTFLDCNTLHSP("CASE0063", lblPayCat.Text.Trim(), HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString(), txtcode.Text.Trim(), BranchGrid.SelectedRows[0].Cells["Branch_Code"].Value.ToString(), SPDetailsGrid.SelectedRows[0].Cells["Group"].Value.ToString(), SPDetailsGrid.SelectedRows[0].Cells["CAMS_Code"].Value.ToString(), "SP");
            propPMTFLDCNTLHEntity = propPMTFLDCNTLHEntity.FindAll(u => u.PMFLDH_CATG == lblPayCat.Text.Trim());
            //else
            //    propPMTFLDCNTLHEntity = _model.FieldControls.GETPMTFLDCNTLHSP("PAYCAT"+ lblPayCat.Text.Trim(), lblPayCat.Text.Trim(), HierarchyGrid.CurrentRow.Cells["Hie_Code"].Value.ToString(), txtcode.Text.Trim(), BranchGrid.CurrentRow.Cells["Branch_Code"].Value.ToString(), SPDetailsGrid.CurrentRow.Cells["Group"].Value.ToString(), SPDetailsGrid.CurrentRow.Cells["CAMS_Code"].Value.ToString(), "SP");
            List<PMTFLDCNTLHEntity> ProgDefFields = _model.FieldControls.GETPMTFLDCNTLHSP("CASE0063", lblPayCat.Text.Trim(), HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString(), "0", " ", "0", "          ", "hie");
            ProgDefFields = ProgDefFields.FindAll(u => u.PMFLDH_CATG == lblPayCat.Text.Trim());
            if (propPMTFLDCNTLHEntity.Count == 0)
            {
                //if (lblPayCat.Text.Trim() == "02")
                propPMTFLDCNTLHEntity = _model.FieldControls.GETPMTFLDCNTLHSP("CASE0063", lblPayCat.Text.Trim(), HierarchyGrid.SelectedRows[0].Cells["Hie_Code"].Value.ToString(), "0", " ", "0", "          ", "hie");
            ...
            bool Isfasle = true;
            if (ProgDefFields.Count > 0 && propPMTFLDCNTLHEntity.Count > 0)
            {
                foreach (PMTFLDCNTLHEntity entity in ProgDefFields)
                {
                    PMTFLDCNTLHEntity ProEntity = propPMTFLDCNTLHEntity.Find(u => u.PMFLDH_CODE == entity.PMFLDH_CODE);

                    if (ProEntity != null)
                    {
                        if (ProEntity.PMFLDH_ENABLED != entity.PMFLDH_ENABLED) { Isfasle = false; break; }
                        if (ProEntity.PMFLDH_REQUIRED != entity.PMFLDH_REQUIRED) { Isfasle = false; break; }
                    }

                }

                List<PMTFLDCNTLHEntity> SelP = propPMTFLDCNTLHEntity.FindAll(u => u.PMFLDH_ENABLED == "Y");
                if (SelP.Count == 1) Isfasle = true;
            }


            if (!Isfasle)
                lblFldcntl.Visible = true;

        }

        private void IsHouseholdButton(string PayCatg)
        {
            //if (PayCatg == "04" && Mode == "Edit")
            //    btnHousehold.Visible = true;
            //else
            //    btnHousehold.Visible = false;
        ...
        private void ADMN1020Form_ToolClick(object sender, ToolClickEventArgs e)
        {
        ...
        //Added Bulk Entry checkbox and related code by Vikash on 09/13/2023 as per Oklahoma WiseJ.doc - SP ADMIN BULK ENTRY 9/12/2023 Point
