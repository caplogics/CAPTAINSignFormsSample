...
{
    public partial class HSSB2108ReportFormVer2 : Form
    {
        ...
        #endregion
        public HSSB2108ReportFormVer2(BaseForm baseForm, PrivilegeEntity privileges)
        {
        ...
        private void On_SaveForm_Closed(object sender, EventArgs e)
        {
            ...
            if (form.DialogResult == DialogResult.OK)
            {
                ...
                Document document = new Document(PageSize.A4, 30f, 30f, 30f, 50f);//new Document(PageSize.A4, 15, 15, 30, 30);
                ...
                try
                {
                    ...
                    float[] widths = new float[] { 60f, 20f, 15f, 16f, 42f, 16f, 16f, 42f, 16f, 16f, 42f, 16f, 16f, 42f, 16f, 16f, 42f, 16f, 35f };
                            ...
                            if (caseEnrlList.Count > 0)
                            {
                                ...
                                foreach (CommonEntity weekDates in commonDate)
                                {
                                    ...
                                    if (rdoYes.Checked == true)
                                    {
                                        ...
                                        pdfNonMealMonday.HorizontalAlignment = Element.ALIGN_CENTER;
                                        pdfNonMealMonday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        pdfNonMealMonday.Colspan = 3;
                                        ...
                                        pdfNonMealTuesday.HorizontalAlignment = Element.ALIGN_CENTER;
                                        pdfNonMealTuesday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        pdfNonMealTuesday.Colspan = 3;
                                        ...
                                        PdfPCell pdfSpaTimeinMonday = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeinMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeinMonday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpaTimeinMonday);
                                        ...
                                        pdfSpaMealMonday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaMealMonday);

                                        PdfPCell pdfSpaTimeoutMonday = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeoutMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeoutMonday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaTimeoutMonday);

                                        PdfPCell pdfSpaTimeinTuesday = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeinTuesday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeinTuesday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpaTimeinTuesday);
                                        ...
                                        pdfSpaMealTuesday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaMealTuesday);

                                        PdfPCell pdfSpaTimeoutTuesday = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeoutTuesday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeoutTuesday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaTimeoutTuesday);

                                        PdfPCell pdfSpaTimeinWed = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeinWed.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeinWed.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpaTimeinWed);
                                        ...
                                        pdfSpaMealWed.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaMealWed);

                                        PdfPCell pdfSpaTimeoutWed = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeoutWed.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeoutWed.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaTimeoutWed);

                                        PdfPCell pdfSpaTimeinThus = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeinThus.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeinThus.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpaTimeinThus);
                                        ...
                                        pdfSpaMealThus.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaMealThus);

                                        PdfPCell pdfSpaTimeoutThus = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeoutThus.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeoutThus.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaTimeoutThus);

                                        PdfPCell pdfSpaTimeinFri = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeinFri.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeinFri.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpaTimeinFri);
                                        ...
                                        pdfSpaMealFri.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaMealFri);

                                        PdfPCell pdfSpaTimeoutFri = new PdfPCell(new Phrase("TIME", TableFont));
                                        pdfSpaTimeoutFri.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpaTimeoutFri.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpaTimeoutFri);
                                        ...
                                        PdfPCell pdfSpa1InMonday = new PdfPCell(new Phrase("IN", TableFont));
                                        pdfSpa1InMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1InMonday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpa1InMonday);
                                        ...
                                        pdfSpa1MealMonday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1MealMonday);

                                        PdfPCell pdfSpa1OutMonday = new PdfPCell(new Phrase("OUT", TableFont));
                                        pdfSpa1OutMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1OutMonday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1OutMonday);


                                        PdfPCell pdfSpa1InTuesday = new PdfPCell(new Phrase("IN", TableFont));
                                        pdfSpa1InTuesday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1InTuesday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpa1InTuesday);
                                        ...
                                        pdfSpa1MealTuesday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1MealTuesday);

                                        PdfPCell pdfSpa1OutTuesday = new PdfPCell(new Phrase("OUT", TableFont));
                                        pdfSpa1OutTuesday.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1OutTuesday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1OutTuesday);


                                        PdfPCell pdfSpa1InWed = new PdfPCell(new Phrase("IN", TableFont));
                                        pdfSpa1InWed.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1InWed.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpa1InWed);
                                        ...
                                        pdfSpa1MealWed.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1MealWed);

                                        PdfPCell pdfSpa1OutWed = new PdfPCell(new Phrase("OUT", TableFont));
                                        pdfSpa1OutWed.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1OutWed.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1OutWed);


                                        PdfPCell pdfSpa1InThus = new PdfPCell(new Phrase("IN", TableFont));
                                        pdfSpa1InThus.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1InThus.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpa1InThus);
                                        ...
                                        pdfSpa1MealThus.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1MealThus);

                                        PdfPCell pdfSpa1OutThus = new PdfPCell(new Phrase("OUT", TableFont));
                                        pdfSpa1OutThus.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1OutThus.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1OutThus);

                                        PdfPCell pdfSpa1InFri = new PdfPCell(new Phrase("IN", TableFont));
                                        pdfSpa1InFri.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1InFri.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpa1InFri);
                                        ...
                                        pdfSpa1MealFri.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1MealFri);

                                        PdfPCell pdfSpa1OutFri = new PdfPCell(new Phrase("OUT", TableFont));
                                        pdfSpa1OutFri.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa1OutFri.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa1OutFri);
                                    ...
                                    PdfPCell pdfSpa2MealInMonday = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa2MealInMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa2MealInMonday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                    table.AddCell(pdfSpa2MealInMonday);
                                    ...
                                    pdfSpa2MealMonday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa2MealMonday);

                                    PdfPCell pdfSpa2MealOutMonday = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa2MealOutMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa2MealOutMonday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa2MealOutMonday);


                                    PdfPCell pdfSpa2MealInTuesday = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa2MealInTuesday.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa2MealInTuesday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                    table.AddCell(pdfSpa2MealInTuesday);
                                    ...
                                    pdfSpa2MealTuesday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa2MealTuesday);

                                    PdfPCell pdfSpa2MealOutTuesday = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa2MealOutTuesday.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa2MealOutTuesday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa2MealOutTuesday);



                                    PdfPCell pdfSpa2MealInWed = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa2MealInWed.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa2MealInWed.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                    table.AddCell(pdfSpa2MealInWed);
                                    ...
                                    pdfSpa2MealWed.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa2MealWed);

                                    PdfPCell pdfSpa2MealOutWed = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa2MealOutWed.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa2MealOutWed.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa2MealOutWed);


                                    PdfPCell pdfSpa3MealInThus = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa3MealInThus.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa3MealInThus.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                    table.AddCell(pdfSpa3MealInThus);
                                    ...
                                    pdfSpa3MealThus.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa3MealThus);

                                    PdfPCell pdfSpa3MealOutThus = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa3MealOutThus.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa3MealOutThus.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa3MealOutThus);


                                    PdfPCell pdfSpa4MealInFri = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa4MealInFri.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa4MealInFri.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                    table.AddCell(pdfSpa4MealInFri);
                                    ...
                                    pdfSpa4MealFri.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa4MealFri);

                                    PdfPCell pdfSpa4MealOutFri = new PdfPCell(new Phrase("    ", TableFont));
                                    pdfSpa4MealOutFri.HorizontalAlignment = Element.ALIGN_LEFT;
                                    pdfSpa4MealOutFri.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                    table.AddCell(pdfSpa4MealOutFri);
                                    ...
                                    foreach (CaseEnrlEntity EnrlDetails in caseEnrlList)
                                    {
                                        ...
                                        if (enrlasofapp != null)
                                        {
                                            ...
                                            PdfPCell pdfMondayInDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfMondayInDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfMondayInDesc.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfMondayInDesc);
                                            ...
                                            pdfMondayDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfMondayDesc);

                                            PdfPCell pdfMondayOutDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfMondayOutDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfMondayOutDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfMondayOutDesc);

                                            PdfPCell pdfTuesInDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfTuesInDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfTuesInDesc.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfTuesInDesc);
                                            ...
                                            pdfTuesDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfTuesDesc);

                                            PdfPCell pdfTuesOutDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfTuesOutDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfTuesOutDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfTuesOutDesc);

                                            PdfPCell pdfWedInDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfWedInDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfWedInDesc.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfWedInDesc);
                                            ...
                                            pdfWedDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfWedDesc);

                                            PdfPCell pdfWedOutDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfWedOutDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfWedOutDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfWedOutDesc);

                                            PdfPCell pdfThurInDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfThurInDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfThurInDesc.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfThurInDesc);
                                            ...
                                            pdfThurDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfThurDesc);

                                            PdfPCell pdfThurOutDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfThurOutDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfThurOutDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfThurOutDesc);

                                            PdfPCell pdfFriIndesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfFriIndesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfFriIndesc.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfFriIndesc);
                                            ...
                                            pdfFridesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfFridesc);

                                            PdfPCell pdfFriOutdesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                            pdfFriOutdesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfFriOutdesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfFriOutdesc);
                                            ...
                                            pdfchildDetails = new PdfPCell(new Phrase("Dismissal Signature", TableFont));
                                            pdfchildDetails.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfchildDetails.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            pdfchildDetails.Colspan = 3;
                                            table.AddCell(pdfchildDetails);

                                            

                                            PdfPCell pdfSingnature = new PdfPCell(new Phrase("   _______________________  ", TableFont));
                                            pdfSingnature.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSingnature.Colspan = 3;
                                            pdfSingnature.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfSingnature);




                                            pdfSingnature = new PdfPCell(new Phrase("   _______________________  ", TableFont));
                                            pdfSingnature.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSingnature.Colspan = 3;
                                            pdfSingnature.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfSingnature);
                                            ...
                                            pdfTotalDesc = new PdfPCell(new Phrase("", TableFont));
                                            pdfTotalDesc.HorizontalAlignment = Element.ALIGN_CENTER;
                                            pdfTotalDesc.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfTotalDesc);
                                    ...
                                    for (int i = 0; i < 3; i++)
                                    {
                                        ...
                                        pdfChildSpaceTuesday.Colspan = 3;
                                        //Headercell6.BackgroundColor = BaseColor.LIGHT_GRAY;
                                    ...
                                    pdfTotalChildTuesday.Colspan = 3;
                                    //Headercell6.BackgroundColor = BaseColor.LIGHT_GRAY;
                            ...
                            if (caseEnrlList.Count > 0)
                            {
                                ...
                                foreach (CommonEntity weekDates in commonDate)
                                {
                                    ...
                                    if (rdoYes.Checked == true)
                                    {
                                        ...
                                        if (dtMonday.Date != Convert.ToDateTime("01/01/1990").Date)
                                        {
                                            PdfPCell pdfSpaMealTimeinMonday = new PdfPCell(new Phrase("TIME", TableFont));
                                            pdfSpaMealTimeinMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSpaMealTimeinMonday.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfSpaMealTimeinMonday);
                                            ...
                                            PdfPCell pdfSpaMealTimeoutMonday = new PdfPCell(new Phrase("TIME", TableFont));
                                            pdfSpaMealTimeoutMonday.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSpaMealTimeoutMonday.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfSpaMealTimeoutMonday);
                                        }
                                        else
                                        {
                                            ...
                                            pdfSpaMealMonday.Colspan = 3;
                                            table.AddCell(pdfSpaMealMonday);
                                        }
                                        if (dtTues.Date != Convert.ToDateTime("01/01/1990").Date)
                                        {
                                            PdfPCell pdfSpaMealTimeIn = new PdfPCell(new Phrase("TIME", TableFont));
                                            pdfSpaMealTimeIn.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSpaMealTimeIn.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfSpaMealTimeIn);
                                            ...
                                            PdfPCell pdfSpaMealTimeout = new PdfPCell(new Phrase("TIME", TableFont));
                                            pdfSpaMealTimeout.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSpaMealTimeout.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfSpaMealTimeout);
                                        }
                                        else
                                        {
                                        ...
                                        if (dtMonday.Date != Convert.ToDateTime("01/01/1990").Date)
                                        {
                                            PdfPCell pdfSpa1MealIn = new PdfPCell(new Phrase("IN", TableFont));
                                            pdfSpa1MealIn.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSpa1MealIn.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                            table.AddCell(pdfSpa1MealIn);
                                            ...
                                            PdfPCell pdfSpa1MealOut = new PdfPCell(new Phrase("Out", TableFont));
                                            pdfSpa1MealOut.HorizontalAlignment = Element.ALIGN_LEFT;
                                            pdfSpa1MealOut.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                            table.AddCell(pdfSpa1MealOut);
                                        }
                                        else
                                        {
                                    ...
                                    if (dtMonday.Date != Convert.ToDateTime("01/01/1990").Date)
                                    {
                                        PdfPCell pdfSpa2MealIn = new PdfPCell(new Phrase("   ", TableFont));
                                        pdfSpa2MealIn.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa2MealIn.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                        table.AddCell(pdfSpa2MealIn);
                                        ...
                                        PdfPCell pdfSpa2MealOut = new PdfPCell(new Phrase("   ", TableFont));
                                        pdfSpa2MealOut.HorizontalAlignment = Element.ALIGN_LEFT;
                                        pdfSpa2MealOut.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                        table.AddCell(pdfSpa2MealOut);
                                    }
                                    else
                                    {
                                    ...
                                    foreach (CaseEnrlEntity EnrlDetails in caseEnrlList)
                                    {
                                        ...
                                        if (enrlasofapp != null)
                                        {
                                            ...
                                            if (dtMonday.Date != Convert.ToDateTime("01/01/1990").Date)
                                            {
                                                PdfPCell pdfInDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                                pdfInDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                                pdfInDesc.Border = iTextSharp.text.Rectangle.LEFT_BORDER;
                                                table.AddCell(pdfInDesc);
                                                ...
                                                PdfPCell pdfOutDesc = new PdfPCell(new Phrase("_____ ", TableFont));
                                                pdfOutDesc.HorizontalAlignment = Element.ALIGN_LEFT;
                                                pdfOutDesc.Border = iTextSharp.text.Rectangle.NO_BORDER;
                                                table.AddCell(pdfOutDesc);
                                            }
                                            else
                                            {
        ...
        /*private void PrintHeaderPage(Document document)
        {
            ...
            PdfPCell row3 = new PdfPCell(new Phrase("Selected Report Parameters", TblFontBold));
            ...
            PdfPCell R2 = new PdfPCell(new Phrase("Children Age :  From " + txtFrom.Text + "  To  " + txtTo.Text, TableFont));
            ...
            if (dtSecond.Checked)
                strStartDate = ", " + dtSecond.Value.ToShortDateString();
            if (dtthird.Checked)
                strStartDate = strStartDate + ", " + dtthird.Value.ToShortDateString();
            if (dtFourth.Checked)
                strStartDate = strStartDate + ", " + dtFourth.Value.ToShortDateString();
            if (dtFifth.Checked)
                strStartDate = strStartDate + ", " + dtFifth.Value.ToShortDateString();
            ...
            if (rdoAllSite.Checked == true) Site = "Site : For All Sites";
            else
            {
        ...
        private void PrintHeaderPage(Document document, PdfWriter writer)
        {
            ...
            PdfPCell R3 = new PdfPCell(new Phrase("  " + "Active/Inactive", TableFont));
            R3.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            PdfPCell R4 = new PdfPCell(new Phrase("  " + "Week Starting Dates", TableFont));
            R4.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            PdfPCell R5 = new PdfPCell(new Phrase("  " + "Base Ages On", TableFont));
            R5.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            PdfPCell R7 = new PdfPCell(new Phrase("  " + "Print Adult meal Info?", TableFont));
            R7.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            PdfPCell R8 = new PdfPCell(new Phrase("  " + "Print a blank line between each Child", TableFont));
            R8.HorizontalAlignment = Element.ALIGN_LEFT;
        ...
        private void dtstartDate_LostFocus(object sender, EventArgs e)
        {
            ...
            {
                _errorProvider.SetError(dtstartDate, null);
                string strMsg = _model.ChldAttnData.CheckHss2108StartingDate(Agency, Dept, Prog, Program_Year,LookupDataAccess.Getdate(dtstartDate.Value.ToShortDateString()));
                if (strMsg == "Y")
                {
        ...
        private void HSSB2108ReportFormVer2_ToolClick(object sender, ToolClickEventArgs e)
        {
